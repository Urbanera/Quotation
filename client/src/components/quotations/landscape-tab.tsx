...
const LandscapeTab: React.FC<LandscapeTabProps> = ({ 
  quotation, 
  companySettings, 
  appSettings,
  id
      ...
      {quotation && companySettings && appSettings ? (
        <div className="flex flex-col">
          <div className="overflow-auto mb-6" style={{ maxHeight: '70vh' }}>
            {/* Cover Page Preview */}
            <div className="border rounded-lg p-8 mb-8 bg-white" style={{ width: '100%', aspectRatio: '1.41 / 1', position: 'relative' }}>
            ...
            {quotation.rooms && quotation.rooms.filter(room => room && room.included).map((room, roomIndex) => 
              room.images && room.images.map((image, imageIndex) => (
                <div 
                  ...
                  style={{ width: '100%', aspectRatio: '1.41 / 1', position: 'relative' }}
                >
                  <div className="absolute top-0 right-0 bg-gray-100 text-xs text-gray-600 px-2 py-1 rounded-bl-md">
