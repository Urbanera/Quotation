...
export default function ViewQuotation() {
  ...
  return (
    <div className="pb-8">
      {/* Warning banner for converted quotations */}
      {isQuotationConverted && (
        <div className="bg-amber-50 border-l-4 border-amber-400 p-4 mx-4 sm:mx-6 lg:max-w-7xl lg:mx-auto rounded-md my-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-amber-700">
                <strong>This quotation has been converted to a sales order.</strong> It is now in read-only mode.
                If you need to make changes, you'll need to revert the sales order back to a quotation first.
              </p>
            </div>
          </div>
        </div>
